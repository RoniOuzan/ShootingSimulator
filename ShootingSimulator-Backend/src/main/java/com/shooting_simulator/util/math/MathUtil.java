...
package com.shooting_simulator.util.math;
...
//      Exception e = new IllegalArgumentException();
    ...
    /**
     * Solves ax^2 + bx + c = 0 for real roots only.
     * Returns an array of 0, 1, or 2 real roots.
     */
    public static double[] quadraticSolver(double a, double b, double c) {
        if (a == 0) {
            // Linear equation bx + c = 0
            if (b == 0) return new double[0]; // no solution
